...
c.hints.padding = {"left": 3, "right": 3, "top": 3, "bottom": 4}
...
config.bind(
    ",a", 'config-cycle content.user_stylesheets ~/.config/qutebrowser/4chan.css ""'
)
config.bind(
    ",b", 'config-cycle content.user_stylesheets ~/.config/qutebrowser/reddit.css ""'
)
config.bind(
    ",w", 'config-cycle content.user_stylesheets ~/.config/qutebrowser/wikipedia.css ""'
)
config.bind(
    ",e", 'config-cycle content.user_stylesheets ~/.config/qutebrowser/empornium.css ""'
)

config.bind(",z", 'config-cycle fonts.default_size "16pt" "14pt"')
config.bind(
    ",x",
    'config-cycle fonts.statusbar "16pt Space Mono Nerd Font" "14pt Space Mono Nerd Font"',
)
config.bind(",p", 'config-cycle fonts.tabs.selected "italic 16pt Space Mono Nerd Font"')
config.bind(
    ",v",
    'config-cycle fonts.downloads "16pt Space Mono Nerd Font" "14pt Space Mono Nerd Font"',
)
config.bind(
    ",n",
    'config-cycle fonts.completion.category "17pt Space Mono Nerd Font" "14pt Space Mono Nerd Font"',
)
config.bind(
    ",m",
    'config-cycle fonts.completion.entry "17pt Space Mono Nerd Font" "14pt Space Mono Nerd Font"',
)
...
config.bind(
    "M",
    'hint links spawn mpv --vo=gpu --hwdec=vaapi --ytdl-format="bestvideo[height<=720]+bestaudio" --audio-device="pulse/alsa_output.pci-0000_00_1f.3.analog-stereo" --script-opts=ytdl_hook-ytdl_path=yt-dlp "{hint-url}"',
)
