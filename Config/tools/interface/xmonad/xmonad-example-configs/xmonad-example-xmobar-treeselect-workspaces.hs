...
myConfigs = [ ("bashrc", myEditor ++ "/home/craole/.bashrc", "the bourne again shell")
            , ("doom emacs config.el", myEditor ++ "/home/craole/.doom.d/config.el", "doom emacs config")
            , ("doom emacs init.el", myEditor ++ "/home/craole/.doom.d/init.el", "doom emacs init")
            , ("dwm", myEditor ++ "/home/craole/dwm-distrotube/config.h", "dwm config file")
            , ("qtile", myEditor ++ "/home/craole/.config/qtile/config.py", "qtile config")
            , ("xmonad.hs", myEditor ++ "/home/craole/.xmonad/xmonad.hs", "xmonad config")
            , ("zshrc", myEditor ++ "/home/craole/.zshrc", "config for the z shell")
            ]
...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 /home/craole/.config/xmobar/xmobarrc0"
    xmproc1 <- spawnPipe "xmobar -x 1 /home/craole/.config/xmobar/xmobarrc2"
    xmproc2 <- spawnPipe "xmobar -x 2 /home/craole/.config/xmobar/xmobarrc1"
